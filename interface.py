...
def predict():
    ...
    #fenetre2.geometry('925x500+300+200')  # 925x500+300+200
    #fenetre2.config(bg='#fff')
    ...
    if len(detection) == 0:
        ...
        #img = PhotoImage(file=plate)
        #Label(fenetre2, image=plate, bg='black').place(x=50, y=50)
...
#Frame(frame,width=295,height=2,bg='black').place(x=10,y=100)
